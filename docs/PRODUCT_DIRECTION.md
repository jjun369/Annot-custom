...
PageDock is a local-first Windows PDF study and technology-research workspace for an individual user. It should remain useful without AI, require no development tools from recipients, and keep every person's library, accounts, credentials, notes, and analyses on that person's PC.
...
- Data stays local and backups are portable across different Windows paths.
